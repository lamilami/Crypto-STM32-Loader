...
static BYTE Wait_Ready (void)
{
    ...
    SD_timer2 = 50;	/* Wait for ready in timeout of 500ms */
...
DSTATUS disk_initialize(BYTE drv)
{
   ...
   for(SD_timer1=100; SD_timer1>0; ); //delay 500ms for power on.
    ...
    type = 0;  //card type.
    SD_timer1 = 200;	/* Initialization timeout of 2000 msec */
